 <%@ Page Language="C#" CodeBehind="~/Exercise3.aspx.cs" MasterPageFile="~/MasterSite.Master" AutoEventWireup="true" Inherits="Module1Exercise1.Exercise3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form runat="server">
        ...
        <asp:Button ID="Calculate" runat="server" Text="Calculate Grade" onclick="Calculate_Click" />
        <br />
        <br />
        <asp:Label ID="finalGradeLbl" runat="server" Text="Final Grade: "></asp:Label>
