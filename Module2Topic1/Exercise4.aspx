...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form runat="server">
        ...
        <asp:RequiredFieldValidator ID="fullnameRFV" ControlToValidate="fullName" runat="server" ErrorMessage="Full Name is Required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
        <br />
        ...
        <asp:RangeValidator ID="ageRV" ControlToValidate="age" runat="server" ErrorMessage="Age must be within the range of 0 to 100" MinimumValue="0" MaximumValue="100" Type="Integer" ForeColor="Red" Display="Dynamic"></asp:RangeValidator>
        <asp:RequiredFieldValidator ID="ageRFV" ControlToValidate="age" runat="server" ErrorMessage="Age is Required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
        <br />
        ...
        <asp:RegularExpressionValidator ID="emailRegExV" ControlToValidate="email"  runat="server" ErrorMessage="Not a Valid Email" ValidationExpression="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$" ForeColor="Red" Display="Dynamic"></asp:RegularExpressionValidator>
        <asp:RequiredFieldValidator ID="emailRFV" ControlToValidate="email" runat="server" ErrorMessage="Email is Required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
        <br />
        ...
        <asp:CompareValidator ID="emailCV" ControlToValidate="confirmEmail" ControlToCompare="email" Operator="Equal" Type="String" runat="server" ErrorMessage="Emails do not match" ForeColor="Red" Display="Dynamic"></asp:CompareValidator>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="confirmEmail" runat="server" ErrorMessage="Email is Required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
        <br />
        <br />
