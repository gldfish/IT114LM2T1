<%@ Page Language="C#" CodeBehind="~/Exercise1.aspx.cs" MasterPageFile="~/MasterSite.Master" AutoEventWireup="true" Inherits="Module1Exercise1.Exercise1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form runat="server">
        ...
        <asp:Label ID="favSong" runat="server" Text="Dress - Taylor Swift"></asp:Label>
        <br />
        ...
        <asp:Image ID="DressCover" runat="server" Height="200px" AlternateText="Dress TS Image Cover" Width="200px" ImageUrl="https://i.pinimg.com/originals/99/ff/dc/99ffdcd7a2de57a1ef3a4904e872ca92.jpg" />
        <br />
        ...
        <asp:Button ID="Button2" runat="server" Text="Play" onclick="btnClickPlay" />
        ...
        <span id="spanDisplay" runat="server"></span>
        <br />
